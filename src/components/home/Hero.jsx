...
const Hero = () => {
    ...
    return (
        <section className={style.container}>
            <Navbar />
            <div className="flex  md:flex-row h-auto md:h-[500px] xl:h-[70vh] hero__content w-full flex-col-reverse pt-10 max-w-[1400px] mb-10">
                <div className="circle rounded-full absolute z-10" />
                <div className='w-100 md:w-[50%] flex items-center md:items-start justify-center md:justify-center  flex-col  md:pt-0 relative'>
                ...
                <div className='w-100 md:w-[50%] flex items-end justify-center flex-col relative'>
