                ...
                <div className="flex flex-wrap items-center md:justify-between justify-center">
                    <div className="w-full md:w-6/12 px-4 mx-auto text-center">
                        <div className="text-sm text-blueGray-500 font-semibold py-1">
                            Made with <Link to="https://www.tolipovjs.uz/" className="text-blueGray-500 hover:text-gray-800" >TolipovJS.uz</Link> by <Link to="https://www.tolipovjs.uz/" className="text-blueGray-500 hover:text-blueGray-800" > Zuyovuddin Tolipov</Link>.
                        </div>
                    </div>
                </div>
            </div>
